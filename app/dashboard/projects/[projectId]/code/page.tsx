...
import { getBranches, getTags, getTree, getReadmeApi, getProjectById, type Branch, type Tag, type TreeEntry, type Project } from "@/lib/api";
...
import { CodeSearch } from "@/components/code/code-search";
    ...
    <div className="flex-1 p-4 md:p-8 lg:p-12 space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
        ...
        <CardContent className="p-3 space-y-3">
          <CodeSearch entries={tree || []} onResults={setFiltered} />
          {treeLoading ? <Skeleton className="h-64 w-full" /> : <FileTree entries={filtered} path={path} onOpen={(p) => setPath(p)} />}
        </CardContent>
        </Card>
